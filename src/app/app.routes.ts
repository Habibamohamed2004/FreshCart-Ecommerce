...
export const routes: Routes = [
    ...
    {path:'shippingaddress/:cartid', component:ShippingaddressComponent, title:'shippingaddress', data: { renderMode: 'client' }},
    ...
    {path:'categories/:categoryId', component:CategoriesComponent, title:'categories', data: { renderMode: 'client' }},
    {path:'brands', component:BrandsComponent, title:'brands'},
    {path:'brands/:brandId', component:BrandsComponent, title:'brands', data: { renderMode: 'client' }},
